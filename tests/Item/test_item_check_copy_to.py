...
def test_item_copy_conflict_detection(parse_item_yaml):
    """Test that copy detects conflicts via plan.has_conflicts."""
    ...
    for test_case in test_env_list:
        ...
        new_item2, plan2 = item.copy(Components(prefix="new_prefix"))
