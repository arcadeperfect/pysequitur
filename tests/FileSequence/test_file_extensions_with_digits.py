from pysequitur import FileSequence, Item, Components, SequenceFactory
...
def test_file_extensions_with_digits():
    ...
    components = Components(
        prefix="file", delimiter=".", padding=4, suffix="suffix", extension="ex1"
    )
    ...
    sequence = SequenceFactory.from_filenames(files)[0]
